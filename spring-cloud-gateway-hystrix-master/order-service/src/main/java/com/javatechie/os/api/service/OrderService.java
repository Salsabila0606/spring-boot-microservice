...
import com.javatechie.os.api.common.*;
...
//        return new TransactionResponse(order, paymentResponse.getAmount(), paymentResponse.getTransactionId(), response);
        ...
        ProductByIdResponse responseProduct = template.getForObject("http://PRODUCT-SERVICE/product/"+order.getProductId(),ProductByIdResponse.class);
        payment.setAmount(responseProduct.getProduct().getPrice()*order.getQty());
